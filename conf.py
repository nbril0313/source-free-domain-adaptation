...
# Weight directory
_C.CKPT_DIR = "/home/ncmssh0313/source-free-domain-adaptation/output/"
...
_C.SETTING.DATASET = 'domainnet126'
...
def load_cfg_from_args():
    ...
    if cfg.SETTING.DATASET == 'office-home':
        cfg.domain = ['Art', 'Clipart', 'Product', 'Real_World']
        cfg.class_num = 65 
